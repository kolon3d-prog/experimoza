...
mainTop.grid_rowconfigure(0, weight=1)
mainTop.grid_columnconfigure(0, weight=1)
mainBottom = ctk.CTkFrame(main)
mainBottom.grid(row=1, column=0, sticky="nsew")
...
choose_button = ctk.CTkButton(mainTop, text="Choose image", command=choose_image)
choose_button.grid(row=0, column=0, sticky="nsew", padx=12, pady=12)

start_button = ctk.CTkButton(mainBottom, text="FEEL THE IMAGE", command=start_wheel)
start_button.grid(row=0, column=0, sticky="nsew", padx=12, pady=12)
stop_button = ctk.CTkButton(mainBottom, text="PANIC STOP :0", command=stop_wheel)
...
image_label = ctk.CTkLabel(right_top, text="No image selected")
